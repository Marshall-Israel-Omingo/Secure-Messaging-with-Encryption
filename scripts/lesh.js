...
/*Functions for event.listerners to run here*/


var md5_btn = document.querySelector("#md5")
var sha256_btn = document.querySelector("#sha256")
var sha512_btn = document.querySelector("#sha512")

md5_btn.addEventListener("click",function(){
  var out_put = document.querySelector("#hash")
    var in_put = document.querySelector("#input").value
    var hshd = hex_md5(in_put) 
    out_put.value = hshd
})

sha256_btn.addEventListener("click",function(){
  var out_put = document.querySelector("#hash")
    var in_put = document.querySelector("#input").value
    var hshd = hex_sha256(in_put) 
    out_put.value = hshd
})
sha512_btn.addEventListener("click",function(){
  var out_put = document.querySelector("#hash")
    var in_put = document.querySelector("#input").value
    var hshd = hex_sha512(in_put)
    out_put.value = hshd
})
